# src/features_extraction/step_7.py
...
def visualize_feature_extraction(
    ...
    fig.suptitle(
        "Stage 3 — Step 1: Feature Extraction (Section III-A)",
        fontsize=13,
        fontweight='bold'
    )
    ...
    legend_elements = [
        Patch(facecolor='steelblue', label='14 Haralick'),
